...
import numpy as np
import pygame as pg
from Klasy_poprawki import Prostokąt, Tablica, Obrecz, Point, CannonBall, Cannon
...
def test_tablica_zmiana_szybkosci():
    ...
    tablica.zmień_szybkość(shots_scored=10, max_shots=40)
